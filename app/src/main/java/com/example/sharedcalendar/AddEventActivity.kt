...
class AddEventActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (schedule == null) {
            ...
            if (selectedDate[Calendar.YEAR] == today[Calendar.YEAR] && selectedDate[Calendar.MONTH] == today[Calendar.MONTH] && selectedDate[Calendar.DAY_OF_MONTH] == today[Calendar.DAY_OF_MONTH]) {
                hour = selectedDate[Calendar.HOUR_OF_DAY]
            } else {
                hour = 8
            }
